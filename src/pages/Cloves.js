...
function Cloves() {
  ...
  const cloveRecipes = getRecipesBySpice("Cloves");

  const content = {
    en: {
      title: "Cloves",
      chineseName: "Chinese Name: 丁香 (dīng xiāng)",
      description:
      ...
      relevance: [
        ...
        "Name means “nail fragrance” due to nail like shape",
        "Was used as breath freshener by anyone meeting the emperor in ancient times",
        "Introduced to China through maritime silk road around 200 BCE.",
      ],
    },
    zh: {
      title: "丁香",
      chineseName: "中文名: 丁香 (dīng xiāng)",
      description:
    ...
    <div className="spice-page">
      ...
      <div className="spice-content">
        <div className="spice-image-showcase">
          <img src={clovesImg} alt={title} className="spice-feature-image" />
        </div>
      ...
      <div className="recipes-section">
        <h2>{language === "en" ? "Clove Recipes" : "丁香食谱"}</h2>
        <RecipeGrid recipes={cloveRecipes} />
      </div>
    </div>
  );
}
